...
class Polynomial_TE {
 private:
  ...
  MaxwellProblem::Data::PolynomialSolutionTE pol_solution;
  MaxwellProblem::Data::PolynomialRhsTE pol_rhs;
...
void Polynomial_TE::output_step() {
...
double Polynomial_TE::compute_error_L2() {
...
void Polynomial_TE::set_max_l2_error(double new_error) {
  if (new_error > max_l2_error) max_l2_error = new_error;
}

void Polynomial_TE::reset_max_l2_error() {
  max_l2_error = 0;
}

Polynomial_TE::Polynomial_TE(
	double time_step_width,
	const std::filesystem::path &path,
...
void Polynomial_TE::setup_triangulation() {
...
void Polynomial_TE::setup_system() {
...
void Polynomial_TE::assemble_system() {
...
void Polynomial_TE::set_time_step_width(double new_time_step_width) {
  time_step_width = new_time_step_width;
  total_time_steps = (end_time - start_time) / time_step_width;
}

double Polynomial_TE::get_time_step_width() {
  return time_step_width;
}

double Polynomial_TE::get_max_l2_error() {
  return max_l2_error;
}

void Polynomial_TE::run() {
