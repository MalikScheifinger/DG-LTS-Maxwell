...
static void MassMatrixAssembly(benchmark::State &state) {
...
BENCHMARK(MassMatrixAssembly)
	->DenseRange(SUBDIVISIONS_START, SUBDIVISIONS_END, SUBDIVISIONS_STEP)
	->Iterations(ITERATIONS)
	->Unit(benchmark::kSecond);

static void MassMatrixAssemblyParallel(benchmark::State &state) {
...
BENCHMARK(MassMatrixAssemblyParallel)
	->DenseRange(SUBDIVISIONS_START, SUBDIVISIONS_END, SUBDIVISIONS_STEP)
	->Iterations(ITERATIONS)
	->Unit(benchmark::kSecond);
